# prLogistic ![](reference/figures/logo.png)
...
When the outcome is common (prevalence \> 10%), the OR from logistic
regression **overestimates** the PR. For example, with a 30% baseline
prevalence and an OR = 2.5, the true PR is closer to 1.8. **prLogistic**
corrects this using conditional or marginal standardisation directly on
the logistic model.
...
|----|----|----|
| [`prLogisticDelta()`](https://raydonal.github.io/prLogistic/reference/prLogisticDelta.md) | `glm` | Independent observations |
| [`prLogisticDelta()`](https://raydonal.github.io/prLogistic/reference/prLogisticDelta.md) | `glmerMod` | Clustered / multilevel data |
| [`prLogisticGEE()`](https://raydonal.github.io/prLogistic/reference/prLogisticGEE.md) | `geeglm` | Longitudinal data (GEE) |
| [`prLogisticSurvey()`](https://raydonal.github.io/prLogistic/reference/prLogisticSurvey.md) | `svyglm` | Complex survey designs |
...
v2](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html) for
details.
